...
import './iPhone11ProMax821.dart';
import 'package:adobe_xd/page_link.dart';
import './first_yard.dart';
import './add_yard_vegetable.dart';
import 'package:flutter_svg/flutter_svg.dart';

class add_yard_fruit extends StatelessWidget {
  add_yard_fruit({
    required Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 182.0, start: 12.0),
            Pin(size: 180.0, middle: 0.4358),
            child:
              ...
              children: <Widget>[
                ...
                Pinned.fromPins(
                  ...
                  Pin(size: 34.0, middle: 0.8151),
                  child:
                      // Adobe XD layer: 'بنع' (text)
                      Scrollbar(
                    child: SingleChildScrollView(
                      child: Text(
                        'عنب',
          ...
          Pinned.fromPins(
            Pin(size: 182.0, end: 19.0),
            Pin(size: 180.0, middle: 0.4358),
            child:
                // Adobe XD layer: 'Group 65' (group)
                PageLink(
              links: [
                PageLinkInfo(
          ...
          Pinned.fromPins(
            Pin(size: 182.0, end: 19.0),
            Pin(size: 180.0, middle: 0.7179),
            child:
                // Adobe XD layer: 'Group 66' (group)
                Stack(
              children: <Widget>[
                Pinned.fromPins(
                  Pin(start: 0.0, end: 0.0),
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => add_yard_vegetable(),
                ),
              ],
              child: Text(
                'خضار',
...
const String _svg_hzpq1 =
    '<svg viewBox="12.0 312.0 182.0 180.0" ><path transform="translate(12.0, 312.0)" d="M 5 0 L 177 0 C 179.7614288330078 0 182 2.238576173782349 182 5 L 182 175 C 182 177.7614288330078 179.7614288330078 180 177 180 L 5 180 C 2.238576173782349 180 0 177.7614288330078 0 175 L 0 5 C 0 2.238576173782349 2.238576173782349 0 5 0 Z" fill="#b59b00" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
...
const String _svg_m7cv02 =
    '<svg viewBox="207.0 205.5 179.5 1.0" ><path transform="translate(207.0, 205.5)" d="M 179.5 0 L 0 0" fill="none" stroke="#11493e" stroke-width="5" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
