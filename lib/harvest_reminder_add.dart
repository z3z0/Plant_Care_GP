...
class harvest_reminder_add extends StatelessWidget {
  harvest_reminder_add({
    Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(size: 151.0, end: 38.0),
            Pin(size: 34.0, middle: 0.4582),
            child:
                // Adobe XD layer: ':ةعارزلا دعوم' (text)
                Text(
              'موعد بداية الحصاد:',
