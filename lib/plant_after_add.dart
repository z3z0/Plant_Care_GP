...
import 'package:plant_care2/swipe_plant_del.dart';
import './swipe_plant_del.dart';
import 'package:adobe_xd/page_link.dart';
import 'package:flutter_svg/flutter_svg.dart';

class plant_after_add extends StatelessWidget {
  plant_after_add({
    required Key key,
  }) : super(key: key);
  @override
    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
              ...
              child: Container(
                decoration: BoxDecoration(
                  ...
                  gradient: LinearGradient(
                    ...
                    colors: [const Color(0xe5518e53), const Color(0xe5291a02)],
                    stops: [0.0, 1.0],
                  ),
                ),
              ),
          ...
          Pinned.fromPins(
            Pin(size: 72.0, start: 52.0),
            Pin(size: 22.0, middle: 0.3787),
            child:
                // Adobe XD layer: '2021/9/5 ذنم' (text)
                Scrollbar(
              child: SingleChildScrollView(
                child: Text(
                  'منذ 2021/9/5',
