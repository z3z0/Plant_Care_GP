...
class planting_reminder_add2 extends StatelessWidget {
  planting_reminder_add2({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 34.0, middle: 0.478),
            child:
                // Adobe XD layer: 'رذب' (text)
                Text(
              'بذر',
              style: TextStyle(
                fontFamily: 'Cairo',
