...
import './iPhone11ProMax661.dart';
import 'package:adobe_xd/page_link.dart';
import './plant_planting_procedure.dart';
import 'package:flutter_svg/flutter_svg.dart';

class planting_reminder_del1 extends StatelessWidget {
  planting_reminder_del1({
    Key key,
  }) : super(key: key);
  @override
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            ...
            Pin(size: 30.0, middle: 0.3406),
            child:
                // Adobe XD layer: 'do_not_disturb_on_b…' (group)
                PageLink(
              links: [
                PageLinkInfo(
            ...
            child:
              ...
              links: [
                PageLinkInfo(
                  ...
                  ease: Curves.easeOut,
                  duration: 0.3,
                  pageBuilder: () => plant_planting_procedure(),
                ),
              ],
              child: Stack(
                children: <Widget>[
...
const String _svg_fxqxw3 =
    '<svg viewBox="2.5 2.5 25.0 25.0" ><path transform="translate(2.5, 2.5)" d="M 12.5 0 C 5.599999904632568 0 0 5.599999904632568 0 12.5 C 0 19.39999961853027 5.599999904632568 25 12.5 25 C 19.39999961853027 25 25 19.39999961853027 25 12.5 C 25 5.599999904632568 19.39999961853027 0 12.5 0 Z M 18.75 13.75 L 6.25 13.75 L 6.25 11.25 L 18.75 11.25 L 18.75 13.75 Z" fill="#fe552f" stroke="none" stroke-width="1" stroke-miterlimit="4" stroke-linecap="butt" /></svg>';
